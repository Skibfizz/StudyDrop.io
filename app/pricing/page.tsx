...
import { Check, Sparkles, Brain, Zap, GraduationCap, Star, ArrowRight, Shield, Clock, Users, Crown } from "lucide-react";
    ...
    <div className="flex min-h-screen flex-col bg-black text-white">
      ...
      <div className="flex-1 space-y-8 p-8 pt-6">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto pt-8">
          {plans.map((plan, index) => (
            <div key={plan.name} className="relative group">
              ...
              <Card className={`relative bg-black border ${plan.popular ? 'border-purple-500' : 'border-white/10'} hover:border-white/20 transition-all duration-500 h-full transform hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/10`}>
                <div className={`absolute inset-0 rounded-lg bg-gradient-to-br ${plan.color} opacity-0 transition-opacity group-hover:opacity-100`} />
                <CardHeader className="relative space-y-4">
                  <div className="flex items-center space-x-4">
                    <div className={`p-2 rounded-lg ${plan.popular ? 'bg-gradient-to-r from-purple-500 to-blue-500' : 'bg-white/10'}`}>
                ...
                <CardContent className="relative space-y-6">
                  <Button 
                    className={`w-full ${plan.buttonColor} transform transition-all duration-300 hover:scale-105 h-12`}
                  ...
                  <div className="space-y-4">
                    {plan.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center text-sm group/feature">
                        <div className={`flex-shrink-0 h-5 w-5 rounded-full ${plan.popular ? 'bg-gradient-to-r from-purple-500 to-blue-500' : 'bg-white/10'} flex items-center justify-center mr-3 group-hover/feature:scale-110 transition-transform`}>
        ...
        <div className="mt-32 max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-16 bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={index} className="group text-left p-6 rounded-xl border border-white/10 hover:border-white/20 transition-all duration-300 hover:bg-white/5">
                <h3 className="font-semibold mb-2 group-hover:text-purple-400 transition-colors">{faq.question}</h3>
          ...
          <div className="relative mx-auto max-w-[920px] text-center space-y-8 py-16">
            ...
            <div className="mt-8 flex items-center justify-center space-x-4">
              ...
              <Button 
                size="lg"
                variant="outline" 
                className="h-14 px-8 text-lg border-white/10 hover:bg-white/5 transform hover:scale-105 transition-all"
              >
                View Demo
