            ...
            <div className="space-y-8">
              <div className="text-center">
                <div className="mb-6 inline-flex items-center justify-center">
                  ...
                  <span className="ml-2 bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-2xl font-bold text-transparent">
                    StudyMind
                  </span>
                </div>
              ...
              <button
                className="group flex h-11 w-full items-center justify-center rounded-lg border border-border bg-white text-gray-600 transition-all hover:border-border/80 hover:bg-gray-50"
              ...
              <form className="space-y-6" onSubmit={handleEmailSignUp}>
                ...
                <div>
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex w-full justify-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                  >
